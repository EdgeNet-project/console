    ...
    return (
        <Stack>
            <Text size="sm">
                ...
                your workspace {workspace.name} on the EdgeNet cluster via kubectl.
            </Text>
            <Alert icon={<IconInfoCircle size="1rem"/>} size="sm">
                ...
                had been downloaded, a new authentication token will be created that will supersede the previous one.
            </Alert>
            <Text size="sm">
...
export default ({workspace}) => {
    ...
    return (
        <>
            <Modal opened={opened} onClose={close} title={"Download "+workspace.name+" KubeConfig"}>
